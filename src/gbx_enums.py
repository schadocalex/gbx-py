...
GbxEDifficultyColor = Enum(Byte, Default=0, White=1, Green=2, Blue=3, Red=4, Black=5)
GbxELightmapQuality = Enum(Byte, Normal=0, High=1, VeryHigh=2, Highest=3, Low=4, VeryLow=5, Lowest=6)
